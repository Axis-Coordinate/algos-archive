...
Source HTML: [`html/2023-04-04-breaking-down-momentum-strategies.html`](../html/2023-04-04-breaking-down-momentum-strategies.html)
...
| 날짜 | 2023-04-04 |
| 접근 | 무료 |
| URL | https://www.algos.org/p/breaking-down-momentum-strategies |
| 부제 | Important ideas behind one of the most popular trading strategies |

---

[![Financial background with abstract numbers and… - Royalty Free Video](images/e307b690df36.jpeg)](images/6a3c3479df5b.jpeg)

#### Introduction

---

By now I think it is safe to assume that everyone has heard enough about pairs trading so this article will take a break and look at one of the best strategies to start with - Momentum. Momentum is easy to do simply and hard to do amazingly. This makes it a great starting point as it is hard to fail with, but there is plenty of room to improve it.

This article will follow the same tune as the previous pairs trading guide where I share some knowledge I’ve gathered along the way on the best ways to implement momentum strategies / what to consider.
...
6. Regime Dependent Performance
7. Information Discreteness
8. Unexpected Volume Changes
9. Turnover Reduction & Portfolio Optimization
10. Continuous Features
11. PSD Momentum
12. Ensemble Ensemble Ensemble
13. Long-Term Momentum as a Factor
14. Backtest Duration Trickery
15. Conclusion
...
2. Reducing turnover
3. Adjusting for recent volatility
...
[![](images/77eb323bfcee.png)](images/4511d2b1433a.png)
...
[![](images/638fa5154ac6.png)](images/f20b9a7c453d.png)
...
1. reaction to new information
2. behaviourally driven
